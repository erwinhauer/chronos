      ...
      <div className="flex flex-col items-center justify-center gap-8 px-6 py-16">
        <div className="flex w-full max-w-sm flex-col gap-8">
          ...
          <div className="flex flex-col gap-1.5">
            <h1 className="text-2xl font-semibold tracking-tight">Nieuw wachtwoord instellen</h1>
            <p className="text-sm text-muted-foreground">Kies een nieuw wachtwoord van minimaal 8 tekens.</p>
          </div>
          <ResetPasswordForm />
        </div>
      </div>
